-- S1D1 (lesson_id: 27) final 17-step structure (safe/id-based)
-- Uses known lesson_step ids 271..283 to avoid order-index collisions.

-- 1-3 Read
update lesson_steps
set order_index = 1, type = 'read', title = 'Ortak, Borsaya Hoş Geldin', content = null,
    metadata = $${
...
where id = 271 and lesson_id = 27;

update lesson_steps
set order_index = 2, type = 'read', title = 'Pazar Mantığı', content = null,
    metadata = $${
...
where id = 272 and lesson_id = 27;

update lesson_steps
set order_index = 3, type = 'read', title = 'Ortaklık Nedir?', content = null,
    metadata = $${
...
where id = 273 and lesson_id = 27;

-- 4 Flashcard, 5 sentence completion
update lesson_steps
set order_index = 4, type = 'flashcard', title = 'Kelime Kartı 1', content = null,
    metadata = $${
      "front_text": "Hisse Senedi",
      "back_text": "Bir şirketin ortaklık payını temsil eden menkul kıymettir."
    }$$::jsonb
where id = 274 and lesson_id = 27;

update lesson_steps
set order_index = 5, type = 'quiz', title = 'Cümle Tamamlama 1', content = null,
    metadata = $${
...
where id = 275 and lesson_id = 27;

-- 6-8 Read
update lesson_steps
set order_index = 6, type = 'read', title = 'Borsa Neden Var?', content = null,
    metadata = $${
...
where id = 276 and lesson_id = 27;

update lesson_steps
set order_index = 7, type = 'read', title = 'Yanlış İnanç: Borsa Şans mı?', content = null,
    metadata = $${
...
where id = 277 and lesson_id = 27;

update lesson_steps
set order_index = 8, type = 'read', title = 'İlk Takip Listesi', content = null,
    metadata = $${
...
where id = 278 and lesson_id = 27;

-- 9 Flashcard, 10 sentence completion
update lesson_steps
set order_index = 9, type = 'flashcard', title = 'Kelime Kartı 2', content = null,
    metadata = $${
      "front_text": "Arz - Talep",
      "back_text": "Fiyat hareketinin temel mekanizmasıdır; talep arttıkça fiyatın yükselme eğilimi güçlenir."
    }$$::jsonb
where id = 279 and lesson_id = 27;

update lesson_steps
set order_index = 10, type = 'quiz', title = 'Cümle Tamamlama 2', content = null,
    metadata = $${
...
where id = 280 and lesson_id = 27;

-- 11-13 Read
update lesson_steps
set order_index = 11, type = 'read', title = 'Senaryo: Yatırım Haberi', content = null,
    metadata = $${
...
where id = 281 and lesson_id = 27;

update lesson_steps
set order_index = 12, type = 'read', title = 'Hızlı Karar Riski', content = null,
    metadata = $${
...
where id = 282 and lesson_id = 27;

update lesson_steps
set order_index = 13, type = 'read', title = 'Dersin Ana Çıktısı', content = null,
    metadata = $${
...
where id = 283 and lesson_id = 27;

-- Remove any previously-added extra steps for this lesson
delete from lesson_steps
where lesson_id = 27 and order_index in (14, 15, 16, 17);

-- 14 Flashcard 3
insert into lesson_steps (lesson_id, type, title, content, order_index, metadata)
values (
  27, 'flashcard', 'Kelime Kartı 3', null, 14,
  $${
...
-- 15 sentence completion 3
insert into lesson_steps (lesson_id, type, title, content, order_index, metadata)
values (
  27, 'quiz', 'Cümle Tamamlama 3', null, 15,
  $${
...
insert into lesson_steps (lesson_id, type, title, content, order_index, metadata)
values (
  27, 'audio', 'Moono Sesli Özet', null, 16,
  $${
...
insert into lesson_steps (lesson_id, type, title, content, order_index, metadata)
values (
  27, 'final_quiz', 'Final Testi', null, 17,
  $${
    "pass_threshold": 7,
    "questions": [
      {
